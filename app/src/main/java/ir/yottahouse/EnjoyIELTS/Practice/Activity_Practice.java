package ir.yottahouse.EnjoyIELTS.Practice;
    ...
    public void SetPropertiesCustomView()
    {
        if(num_type == 1)
        {
            ...
            }else if(getIntent().getExtras().getString("Hard") != null)
            {
                ...
                SetSettingCustomItem("","transcription",custom1,getResources().getDrawable(R.drawable.practice_icon));
                SetSettingCustomItem("","short items",custom2,getResources().getDrawable(R.drawable.practice_icon));
